...
- **Good First Issues Misuse:** The purpose of a “good first issue” is not getting the low-priority bug fixed, it is to allow human contributors to get familiar with `qutip-qip`, with the GitHub workflow and to engage with the community. AI can be used as a learning aid to understand the codebase, but the final implementation must be your own work. Submitting fully AI-generated PRs for “good first issues” is not permitted.
